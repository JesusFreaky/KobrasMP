...
NDiplomacy = {
	...
	PREPARE_FOR_WAR_MONTHS = 24,					-- Number of months AI will prepare for war
	...
	OFFENSIVE_WAR_COOLDOWN = 5,					-- Years between when you can call a country into an offensive war on your behalf
	...
	ABANDON_UNION_PRESTIGE = -1,					-- The change in prestige for the overlord when abandoning a personal union.
...
NCountry = {
	...
	ABDICATE_AGE_THRESHOLD = 40,
	ABDICATE_RULING_LENGTH_THRESHOLD = 5,
	ABDICATE_LEGITIMACY_HIT = -10,
	ABDICATE_PRESTIGE_HIT = -20,


	DISINHERIT_PRESTIGE_HIT = -15,
	DISINHERIT_PRESTIGE_THRESHOLD = -50,
	...
	NEW_HEIR_PRESTIGE_HIT = -10,
	NEW_HEIR_PRESTIGE_THRESHOLD = 0,
	NEW_HEIR_LEGITIMACY_HIT = -15,
	...
	MAXIMUM_CONDOTTIERI = 25,					-- Base number of units you can rent out
	...
	FEMALE_ADVISOR_CHANCE = 5,						-- If Women in History is enabled, chance of an advisor (or general if permitted) spawning as female
	...
	GRANT_ADMINISTRATIVE_AUTONOMY_REFORM_PROGRESS_COST = 10,
	...
	CONVERSION_COOLDOWN = 60,						-- months before you can convert again.
	CONVERSION_COOLDOWN_SECONDARY = 60,			-- months before you can convert secondary religion again.
	...
	STRENGTHEN_GOVERNMENT_LEGITIMACY = 15,
	STRENGTHEN_GOVERNMENT_REPUBLICAN_TRADITION = 5,
	STRENGTHEN_GOVERNMENT_HORDE_UNITY = 15,
	STRENGTHEN_GOVERNMENT_DEVOTION = 15,
	STRENGTHEN_GOVERNMENT_MERITOCRACY = 15,
	...
	CLAIM_THRONE_PRESTIGE_PENALTY = 15.0,			-- Prestige penalty when claiming throne
	...
	CLAIM_LOSE = 30,								-- how many years until a claim is lost.
	...
	MONTHS_TO_CORE_MINIMUM = 3,						-- Minimum amount of months it will take to core a province after all modifiers.
	MONTHS_TO_CORE = 36,							-- How many months it will take to core a province.
	MONTHS_TO_CHANGE_CULTURE = 9,					-- How many months it will take to change culture in a province, per development.
...
NEconomy = {
	...
	GOLD_MINE_SIZE_PRIMITIVES = 6,					-- Gold income for very slow techgroups
	...
	CONSTRUCT_IN_SUBJECT_TIME_MULTIPLIER = 1.2,
...
NMilitary = {
	...
	BACK_LINE_MORALE_DAMAGE_TAKEN_MODIFIER = -0.15,	-- Multiplier for morale damage taken by backrow
	...
	DEFAULT_WARGOAL_TICKINGWARSCORE_BONUS = 0.8,		-- Amount of warscore per month since attacker/defender started getting the bonus for completing war goal
	...
	CREATE_JANISSARIES_MIL_COST = 2,				-- Cost to create janissaries (per unit)
...
NNationDesigner = {
	...
	POINTS_AVAILABLE = 75000,
	RULER_BASE_AGE = 15,					-- Creating a ruler with this age is free.
	RULER_MIN_AGE = 14,						--
	RULER_MAX_AGE = 100,
	HEIR_BASE_AGE = 15,	--
	HEIR_MIN_AGE = 0,
	...
	CONSORT_MIN_AGE = 15,
	CONSORT_MAX_AGE = 100,
	RULER_BASE_SKILL = 4,					-- This ruler skill level is free.
	RULER_MAX_SKILL = 10,
	...
	IDEAS_PERCENTAGE_LIMIT = 75,			-- Max % from any one category to not get overstacking penalty
	...
	IDEAS_LEVEL_COST_5 = 40,
	IDEAS_LEVEL_COST_6 = 55,
	IDEAS_LEVEL_COST_7 = 70,
	IDEAS_LEVEL_COST_8 = 80,
	IDEAS_LEVEL_COST_9 = 90,
	IDEAS_LEVEL_COST_10 = 100,
	IDEAS_LEVEL_COST_11 = 110,				
	IDEAS_LEVEL_COST_12 = 120,
	IDEAS_LEVEL_COST_13 = 130,
	IDEAS_LEVEL_COST_14 = 135,
	IDEAS_LEVEL_COST_15 = 140,
	IDEAS_LEVEL_COST_16 = 155,
	IDEAS_LEVEL_COST_17 = 170,
	IDEAS_LEVEL_COST_18 = 180,
	IDEAS_LEVEL_COST_19 = 190,
	IDEAS_LEVEL_COST_20 = 200,
	IDEAS_MAX_LEVEL = 25,					-- Can be overriden in script
	FLAT_TAX_AMOUNT = 4,					-- How much tax per province in 'flat' option
	FLAT_MP_AMOUNT = 3,						-- How much manpower per province in 'flat' option
	MAX_DISTANCE_TO_OWNER_AREA = 10000,
	MAX_DISCOVERED_PROVINCE_DISTANCE = 500,
	DEFAULT_MALE_CHANCE = 90,				-- Default chance for males if ruler and heir start genders aren't the same.
...
NGovernment = {
	...
	LEADER_AS_MONARCH_TRADITION = 50, -- How much tradition leaders will get when generated for
